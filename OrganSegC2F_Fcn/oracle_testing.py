...
if __name__ == '__main__':
    ...
    test_result_epoch = '12'

    #test_result_epoch_v2 = '8'

    test_iteration_list = [0]
    ...
    with tf.Session() as sess:
        ...
        for k in range(len(test_iteration_list)):
            ...
            #result_directory = '/media/jionie/Disk1/results/oracle/fcn_vgg/test/oracle_' + train_plane + '_' + str(current_fold) + '/' \
            #+ train_plane + '_' + str(current_fold) + '_' + test_result_epoch + '_' + test_result_epoch + '/' + str(test_iteration) + '/' 
            
            
            result_directory = '/media/jionie/Disk1/results/oracle/fcn_vgg/test/oracle_' + train_plane + '_' + str(current_fold) + '_v2/' \
            ...
            #model_path = '/media/jionie/Disk1/checkpoints/fine/fcn_vgg/X/X_1_12/' + str(test_iteration) + '/'
            model_path =  '/media/jionie/Disk1/checkpoints/fine/fcn_vgg/' + train_plane + '/' + train_plane + '_' + str(current_fold) + '_5/'
