...
if __name__ == '__main__':
    ...
    #npy_file_list = ["/media/jionie/Disk1/results/coarse/fcn_vgg/test/coarse_X_0/9.npz", "/media/jionie/Disk1/labels/0009.npy"]

    
    print(npy_file_list)
    image = np.load(npy_file_list[0])
    ...
    ax1.imshow(image_z, cmap = 'gray')

    ax2 = fig1.add_subplot(1,2,2)
    ax2.imshow(label_z, cmap = 'gray')
