...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for k in range(len(test_iteration_list)):
            ...
            result_directory = '/media/jionie/Disk1/results/coarse/fcn_vgg/test/coarse-' + train_plane + '_' + str(current_fold) + '/'
            
            #result_directory = '/media/jionie/Disk1/results/coarse/fcn_vgg/test/coarse-' + train_plane + '/' + \
            #'coarse-' + train_plane + '_epoch_' + test_result_epoch + '_v2/'
            ...
            model_path= checkpoint_path + train_plane + '/' + train_plane + '_' + str(current_fold) + '/' 
                    ...
                    for j in range(minR, maxR):
                        ...
                        if slice_thickness == 1:
                            ...
                            if train_plane == 'X':
                                ...
                                pred[j, :, :] = logits_final[0:image_width, 0:image_height, 0]
