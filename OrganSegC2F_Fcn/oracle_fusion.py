...
if __name__ == '__main__':
    ...
    for current_fold in range(0, 4): 
        ...
        result_name = 'fusion:' + 'X' + '_' + 'Y' + '_' + 'Z'
        result_directory = '/media/jionie/Disk1/results/oracle_gan/fcn_vgg/test/' + result_name  + '_' + str(current_fold) + '/'
        ...
        for i in range(len(volume_list)):
            ...
            for plane in ['X', 'Y', 'Z']:
                ...
                if plane == 'X':
                    volume_file = '/media/jionie/Disk1/results/oracle_gan/fcn_vgg/test/oracle_X_' + str(current_fold) + '/' +\
                    str(i + 1) + '.npz'
                
                elif plane == 'Y':
                    volume_file = '/media/jionie/Disk1/results/oracle_gan/fcn_vgg/test/oracle_Y_' + str(current_fold) + '/' +\
                    str(i + 1) + '.npz'
                
                else:
                    volume_file = '/media/jionie/Disk1/results/oracle_gan/fcn_vgg/test/oracle_Z_' + str(current_fold) + '/' +\
                    str(i + 1) + '.npz'
